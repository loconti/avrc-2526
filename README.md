...
| 10 | Advanced D3.js — Update Pattern, Transitions, Interactions, Layouts, Zoom | [dv10-d3-shapes-layouts.pdf](dataviz/slides/dv10-d3-shapes-layouts.pdf) | [tutorials/10-d3js-shapes-layouts/](dataviz/tutorials/10-d3js-shapes-layouts/index.html) — 5 long-form tutorials (10a–10e) + 24 self-contained examples |
| 11 | Networks with D3.js — NetworkX→D3.js, Force Layouts, Interactivity, Encoding, Performance | | [tutorials/11-networks-d3js/](dataviz/tutorials/11-networks-d3js/index.html) — 7 long-form tutorials (11a–11h) + 21 self-contained examples |
